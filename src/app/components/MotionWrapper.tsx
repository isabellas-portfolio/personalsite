    ...
    <section className="min-h-screen px-8 lg:px-24 py-20 bg-white flex flex-col-reverse lg:flex-row items-center justify-between gap-12 font-jost">
      ...
      >
        ...
        <div className="space-y-1 text-black">
          ...
          <p className="text-sm">
            <span className="inline-block animate-spin-slow text-anjana">❀</span> Incoming Product Manager @ <a href="https://www.ibm.com/us-en" className="underline text-anjana">IBM</a>
          </p>
          <p className="text-sm">
