...
export const projects = [
    ...
    },
    {
      ...
      partner: "The Housing Innovation Lab at the City of Boston",
      overview:
        "Led a team of 5 to explore home-sharing practices, produce stakeholder maps, journey maps, and a research-backed process book.",
      responsibilities: [
        "Designed and launched survey to assess housing needs.",
        "Facilitated biweekly stakeholder comms and agile workflows.",
        "Reduced turnaround by 20% through improved team structure.",
        "Created detailed documentation including literature review."
      ],
      links: [],
    }
  ];
